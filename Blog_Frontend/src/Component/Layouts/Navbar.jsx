      ...
      <div className="w-full bg-[#FFD803]">
        <div className="flex justify-between w-[90%] h-[48px] mx-auto bg-[#FFD803]">
          ...
          <div className="my-auto space-x-2  flex justify-between">
            <span className="font-bold my-auto bg-[#272343] text-[#BAE8E8] px-2 py-1 rounded-md">
              <Link to='/login'>Login</Link>
            </span>
            <span className="font-bold my-auto bg-[#272343] text-[#BAE8E8] rounded-md">
              <label className="swap swap-rotate w-8 h-8 my-auto">
