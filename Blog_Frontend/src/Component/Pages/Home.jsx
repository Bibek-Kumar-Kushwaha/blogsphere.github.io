    ...
    <div className="min-h-screen bg-cover bg-center relative" style={{ backgroundColor: '#F3FBFB' }}>
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center z-10">
        <div className="text-center text-text">
          ...
          <a href="/blogs" className="bg-button-bg hover:hover:bg-button-hover-bg text-gray-900 font-bold py-3 px-6 rounded-full shadow-lg transition duration-300 inline-block">Explore Blogs</a>
        </div>
      </div>
    </div>
  );
